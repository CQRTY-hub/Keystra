# Keystra — Terms and conditions

**Language:** English
**Version:** 2026-08-30
**Status:** This is the legally binding version of the terms and conditions. The Dutch version (`algemene-voorwaarden-nl.pdf`) exists purely so Dutch-speaking buyers can understand this text, and does not carry its own version number — where the two differ, this English text governs.
...
Who we are, and who we sell to. Keystra is the trade name under which Hamish Vandersype (Sole trader (eenmanszaak) under Belgian law, company number 1008236113, VAT number BE1008236113) operates this webshop, based at Kloosterstraat 7, 8560 Wevelgem, Belgium. Questions can be sent to sectechoffers@gmail.com; we aim to reply within 2 business days. **[TO BE CONFIRMED BY LAWYER: is a stated response time an acceptable stand-in for a phone number? This shop has no phone-based customer service — one person, no call desk — hence this instead of an unstaffed phone line.]** This shop sells to private consumers only, not businesses. If you're ordering on behalf of a business, or for business use, contact us first — these terms aren't written for that.
